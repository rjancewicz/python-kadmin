...
int PyKAdminError_init_krb5(PyObject *module) {
    ...
    if (_pykadmin_krb5_errors) {
        ...
        PyKAdminError_krb5_insert(module, KRB5KDC_ERR_DH_KEY_PARAMETERS_NOT_ACCEPTED,       "KDCKeyParamsError",        "Key parameters not accepted");
        ...
        PyKAdminError_krb5_insert(module, KRB5_ERR_BAD_S2K_PARAMS,                          "KeyParamsError",          "Invalid key generation parameters from KDC");
...
int PyKAdminError_init_kadm(PyObject *module) {
    ...
    if (_pykadmin_kadm_errors) {
        ...
        PyKAdminError_kadm_insert(module, KADM5_BAD_DB,                   "DadtabaseError",               "Database inconsistency detected");
        ...
        PyKAdminError_kadm_insert(module, KADM5_BAD_HIST_KEY,             "HistoryKeyError",              "Password history principal key version mismatch");
        ...
        PyKAdminError_kadm_insert(module, KADM5_BAD_MASK,                 "MaskError",                    "Invalid field mask for operation");
        PyKAdminError_kadm_insert(module, KADM5_BAD_CLASS,                "ClassError",                   "Invalid number of character classes");
        PyKAdminError_kadm_insert(module, KADM5_BAD_LENGTH,               "LengthError",                  "Invalid password length");
        PyKAdminError_kadm_insert(module, KADM5_BAD_POLICY,               "PolicyError",                  "Illegal policy name");
        PyKAdminError_kadm_insert(module, KADM5_BAD_PRINCIPAL,            "PrincipalError",               "Illegal principal name");
        PyKAdminError_kadm_insert(module, KADM5_BAD_AUX_ATTR,             "AuxAttrError",                 "Invalid auxillary attributes");
        PyKAdminError_kadm_insert(module, KADM5_BAD_HISTORY,              "HistoryError",                 "Invalid password history count");
        PyKAdminError_kadm_insert(module, KADM5_BAD_MIN_PASS_LIFE,        "MinPasswordLifeError",         "Password minimum life is greater then password maximum life");
        ...
        PyKAdminError_kadm_insert(module, KADM5_BAD_PASSWORD,             "PasswordError",                "Incorrect password");
        PyKAdminError_kadm_insert(module, KADM5_PROTECT_PRINCIPAL,        "ProtectedPrincipalError",      "Cannot change protected principal");
        PyKAdminError_kadm_insert(module, KADM5_BAD_SERVER_HANDLE,        "ServerHandleError",            "Programmer error! Bad Admin server handle");
        PyKAdminError_kadm_insert(module, KADM5_BAD_STRUCT_VERSION,       "StructVersionError",           "Programmer error! Bad API structure version");
        ...
        PyKAdminError_kadm_insert(module, KADM5_BAD_API_VERSION,          "APIVersionError",              "Programmer error! Bad API version");
        ...
        PyKAdminError_kadm_insert(module, KADM5_BAD_CLIENT_PARAMS,        "ClientParamsError",            "Illegal configuration parameter for remote KADM5 client");
        PyKAdminError_kadm_insert(module, KADM5_BAD_SERVER_PARAMS,        "ServerParamsError",            "Illegal configuration parameter for local KADM5 client.");
        ...
        PyKAdminError_kadm_insert(module, KADM5_BAD_TL_TYPE,              "TLTypeError",                  "Programmer error! Illegal tagged data list element type");
        ...
        PyKAdminError_kadm_insert(module, KADM5_BAD_SERVER_NAME,          "ServerNameError",              "Bad krb5 admin server hostname");
